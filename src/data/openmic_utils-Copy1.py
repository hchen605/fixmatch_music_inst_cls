...
# Finally, cast the idx_* arrays to numpy structures
    ...
    train_dataset = Subset(OPENMIC, idx_train)
    val_dataset = Subset(OPENMIC, test_set)
    test_dataset = Subset(OPENMIC, test_set)
    ...
    return (train_loader, val_loader, test_loader), (OPENMIC, train_set)
    '''
