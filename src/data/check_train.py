...
X_open, Y_true, Y_mask, sample_key = OPENMIC['X'], OPENMIC['Y_true'], OPENMIC['Y_mask'], OPENMIC['sample_key']
print('---- OPENMIC.npz ----')
print(X_open.shape)

OPENMIC = np.load(os.path.join(abs_path, 'train.npz'), allow_pickle=True)
print(list(OPENMIC.keys()))
X_train, Y_true, Y_mask, sample_key = OPENMIC['X'], OPENMIC['Y_true'], OPENMIC['Y_mask'], OPENMIC['sample_key']
print('---- train.npz ----')
print(X_train.shape)

OPENMIC = np.load(os.path.join(abs_path, 'test.npz'), allow_pickle=True)
print(list(OPENMIC.keys()))
X_test, Y_true, Y_mask, sample_key = OPENMIC['X'], OPENMIC['Y_true'], OPENMIC['Y_mask'], OPENMIC['sample_key']
print('---- test.npz ----')
print(X_test.shape)
...
#train_dataset_open = Subset(full_dataset, train_val_split['train'])
train_dataset_open = Subset(full_dataset, idx_train)
...
for i in range(len(idx_train)):
    ...
    #print('---- train_dataset_open[' + str(i) + '] ----')
    X_open, Y_true_open, Y_mask_open = full_dataset[idx_train[i]]
    #print(X_open)
    #print(Y_true_open)
    #print(Y_mask_open)
    
    #print('---- train_dataset[' + str(i) + '] ----')
    X, Y_true, Y_mask = train_dataset_all[i]
    #print(X)
    #print(Y_true)
    #print(Y_mask)
...
print('train all error cnt = ', count)
...
for i in range(len(train_val_split['train'])):
    ...
    #print('---- train_dataset_open[' + str(i) + '] ----')
    X_open, Y_true_open, Y_mask_open = train_dataset_open[train_val_split['train'][i]]
    #print(X_open)
    #print(Y_true_open)
    #print(Y_mask_open)
    
    #print('---- train_dataset[' + str(i) + '] ----')
    X, Y_true, Y_mask = train_dataset[i]
    #print(X)
    #print(Y_true)
    #print(Y_mask)
...
for i in range(len(idx_test)):
    ...
    #print('---- train_dataset_open[' + str(i) + '] ----')
    X_open, Y_true_open, Y_mask_open = full_dataset[idx_test[i]]
    #print(X_open)
    #print(Y_true_open)
    #print(Y_mask_open)
    
    #print('---- train_dataset[' + str(i) + '] ----')
    X, Y_true, Y_mask = test_dataset[i]
    #print(X)
    #print(Y_true)
    #print(Y_mask)
...
print('test all error cnt = ', count)


#check valid data
count = 0

for i in range(len(train_val_split['val'])):
    
    #print('---- train_dataset_open[' + str(i) + '] ----')
    X_open, Y_true_open, Y_mask_open = train_dataset_open[train_val_split['val'][i]]
    #print(X_open)
    #print(Y_true_open)
    #print(Y_mask_open)
    
    #print('---- train_dataset[' + str(i) + '] ----')
    X, Y_true, Y_mask = val_dataset[i]
    #print(X)
    #print(Y_true)
    #print(Y_mask)
